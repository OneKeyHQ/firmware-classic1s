...
loop:
  layoutDialogAdapterEx(_(T__LNURL_AUTHORIZATION), &bmp_bottom_left_close, NULL,
                        &bmp_bottom_right_arrow, NULL, NULL, _(I__DOMAIN_COLON),
...
__data:
  oledClear();
  layoutHeader(_(T__LNURL_AUTHORIZATION));
  ...
  layoutDialogCenterAdapterV2(
      _(T__APPROVE_REQUEST), NULL, &bmp_bottom_left_close,
      &bmp_bottom_right_confirm, NULL, NULL, NULL, NULL, NULL, NULL,
      _(C__DO_YOU_WANT_TO_APPROVE_LNURL_AUTH_REQUEST_QUES));
  key = protectWaitKey(0, 1);
  if (key != KEY_CONFIRM) {
    return false;
  }
