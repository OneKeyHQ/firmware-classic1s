...
#define FLASH_OTP_BLOCK_THD89_PUBLIC_KEY1 4
#define FLASH_OTP_BLOCK_THD89_PUBLIC_KEY2 5
#define FLASH_OTP_BLOCK_BLE_PUBLIC_KEY1 6
#define FLASH_OTP_BLOCK_BLE_PUBLIC_KEY2 7
