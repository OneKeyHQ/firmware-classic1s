...
uint16_t __polkadot_decimal = COIN_AMOUNT_DECIMAL_PLACES;
...
parser_error_t _toStringCompactBalance(const pd_CompactBalance_t *v,
  ...
  CHECK_ERROR(_toStringCompactInt(&v->value, __polkadot_decimal, true,
...
uint16_t getAddressType() { return __address_type; }
