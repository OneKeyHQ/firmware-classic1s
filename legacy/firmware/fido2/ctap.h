...
#define CRED_ID_RP_ID               0x01
#define CRED_ID_RP_NAME             0x02
#define CRED_ID_USER_ID             0x03
#define CRED_ID_USER_NAME           0x04
#define CRED_ID_USER_DISPLAY_NAME   0x05
#define CRED_ID_CREATION_TIME       0x06
#define CRED_ID_HMAC_SECRET         0x07
...
#define CRED_ID_VERSION             "\xf1\xd0\x02\x00"
#define CRED_ID_VERSION_SIZE        4
#define CTAP1_KEY_HANDLE_SIZE       64

#define AUTH_DATA_FLAG_UP           (1 << 0)
#define AUTH_DATA_FLAG_UV           (1 << 2)
#define AUTH_DATA_FLAG_AT           (1 << 6)
#define AUTH_DATA_FLAG_ED           (1 << 7)
...
#define RP_NAME_LIMIT               64  // application limit, name parameter isn't needed.
...
#define USER_PRESENCE_TIMEOUT timer1s * 30

typedef struct
{
    uint8_t id[USER_ID_MAX_SIZE];
    uint8_t id_size;
    char name[USER_NAME_LIMIT + 1];
    char displayName[DISPLAY_NAME_LIMIT + 1];
...
struct rpId
{
    char id[DOMAIN_NAME_MAX_SIZE + 1];     // extra for NULL termination
    size_t size;
    char name[RP_NAME_LIMIT + 1];
};
...
#define CTAP_CREDENTIAL_ID_MIN_SIZE (4+12+16+1)
