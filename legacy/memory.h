...
#define FLASH_BLE_SECTOR_FIRST 27
#define FLASH_BLE_SECTOR_LAST 27

#define FLASH_BLE_ADDR_START (0x082C0000)
#define FLASH_INIT_DATA_START (FLASH_BLE_ADDR_START + FLASH_FWHEADER_LEN)
